...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s diamondhands-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  diamondhands-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diamondhands transaction") + "\n" +
              "  diamondhands-tx [options] -create [commands]   " + _("Create hex-encoded diamondhands transaction") + "\n" +
              "\n";
