...
"""Verify that starting diamondhands with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start diamondhands with -h for help text")
        ...
        self.log.info("Start diamondhands with -version for version information")
