...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 29031
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 29032
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 39031
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 39032
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 29031
	%{_sbindir}/semanage port -d -p tcp 29032
	%{_sbindir}/semanage port -d -p tcp 39031
	%{_sbindir}/semanage port -d -p tcp 39032
